  ...
  return (
    <div className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-8 text-white">
      <div className="space-y-2">
        ...
        <h1 className="text-3xl font-semibold">Cart retired — shop on Spring</h1>
        <p className="text-sm text-white/70">
          We moved checkout to our Spring (Teespring) storefront at store.groupseven.life. Use the link below to browse and buy;
          this app now focuses on the community hub experience.
        </p>
      </div>
